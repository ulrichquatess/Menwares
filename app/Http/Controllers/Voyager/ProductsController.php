...
class ProductsController extends VoyagerBreadController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $categories = Category::all();
//the line below helps us to get the checkbox option
        $product = Product::find($id);
        $categoriesForProduct = $product->category()->get();
//category() is the name found in the product model that is the relationship
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!$request->ajax()) {
            ...
            //Here is our own category first delete
